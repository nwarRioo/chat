...
const LoginPage: React.FunctionComponent = (): React.ReactElement => {
    ...
    const [userValues, setUserValues] = useState<IUserLoginDto>({
        login: '',
        password: ''
    });
    ...
    const submitHandler = async (e: React.FormEvent) => {
        ...
        if (userValues.login.trim() === '') {
            setUsernameFieldErrorMessage('Login is required!')
            return;
        }
                    ...
                    <div className="LoginPage-form-column">
                        <form onSubmit={submitHandler}>
                            <div className="LoginPage-form-box">
                                <label className="LoginPage-label" htmlFor='login'>Login:</label>
